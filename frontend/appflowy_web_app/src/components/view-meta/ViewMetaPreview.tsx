...
export function ViewMetaPreview ({ icon, cover, name }: ViewMetaProps) {
  ...
  return (
    <div className={'flex w-full flex-col items-center'}>
      ...
      <div
        className={`relative mb-6 mt-[52px] max-md:mt-[38px] w-[964px] min-w-0 max-w-full overflow-visible max-lg:px-6`}
      >
        <div
          className={
            'flex gap-4 overflow-hidden whitespace-pre-wrap break-words break-all text-[2.25rem] font-bold leading-[2em] max-lg:text-[7vw] max-lg:leading-[1.5em]'
          }
        >
